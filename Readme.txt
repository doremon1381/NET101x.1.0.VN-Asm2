...
/{unitId}/referenceNo/{referenceNo}		        and userId will come along with accesstoken
5.3.2. GET /booking/unitId/{unitId}	       --> GET /booking/unitId/{id}/details - I ignore referenceNo
/referenceNo/{referenceNo}/details		       , userId will come along with accesstoken
5.3.3. POST /booking/userId/{userId}/records   --> GET /booking/unitId/{appointmentId}/records - I add 
							...
							leave userId for accesstoken, now this endpoint will need
							userId and appointmentId as parameters
